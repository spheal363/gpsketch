...
VALUES
  (UUID(), 'ねこ', 5.0, 5.2, '{"type": "LineString", "coordinates": [[139.6917, 35.6895], [139.7000, 35.6900]]}', 35.6895, 139.6917, 'https://example.com/cat.png', '{"northwest": [139.6900, 35.6900], "southeast": [139.7000, 35.6800]}'),
  (UUID(), 'いぬ', 3.0, 3.1, '{"type": "LineString", "coordinates": [[139.7000, 35.6800], [139.7100, 35.6850]]}', 35.6800, 139.7000, 'https://example.com/dog.png', '{"northwest": [139.6950, 35.6850], "southeast": [139.7100, 35.6750]}');
